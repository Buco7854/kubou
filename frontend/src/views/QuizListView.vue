    ...
    <div class="max-w-5xl mx-auto">
      <div class="flex justify-between items-center mb-6 sm:mb-8">
        ...
        <div class="flex space-x-2 sm:space-x-3">
          <router-link
            to="/ai-quiz"
            class="inline-flex items-center justify-center w-10 h-10 sm:w-auto sm:h-auto sm:px-6 sm:py-3 border border-purple-600 font-medium rounded-full shadow-sm text-purple-600 bg-white hover:bg-purple-50 transition transform hover:scale-105"
            :title="t('nav.aiQuiz')"
          >
            ...
            <span class="hidden sm:inline text-base">{{ t('nav.aiQuiz') }}</span>
          </router-link>
          <router-link
            to="/import-quiz"
